...
public class TestCachedCachedRecordArray extends TestRecordArray
{
	@Override
	protected RecordArray createRecordArray() throws IOException
	{
		return new CachedRecordArray(new CachedRecordArray(
				new PlainRecordArray(new RandomFileAccesser(testFile), 128),
				1024), 512);
	}
}
